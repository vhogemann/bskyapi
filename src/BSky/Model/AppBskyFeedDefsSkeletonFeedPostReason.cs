...
namespace BSky.Model
{
    ...
    public partial class AppBskyFeedDefsSkeletonFeedPostReason : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(AppBskyFeedDefsSkeletonReasonRepost) || value is AppBskyFeedDefsSkeletonReasonRepost)
                {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return AppBskyFeedDefsSkeletonFeedPostReason.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
